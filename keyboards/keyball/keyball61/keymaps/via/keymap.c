...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_universal(
    ...
    KC_TAB, KC_A , KC_S , KC_D , KC_F , KC_G               ,                                  KC_H                , KC_J         , KC_K   , KC_L  , MT(MOD_LALT,KC_SCLN), MT(MOD_LGUI,KC_QUOT),
    KC_NO , KC_Z , KC_X , KC_C , KC_V , KC_B               , KC_LBRC,    KC_RBRC            , KC_N                , KC_M         , KC_COMM, KC_DOT, KC_SLSH             , KC_BSLS             ,
    KC_NO , MO(2), KC_NO, KC_NO, KC_NO, MT(MOD_LSFT,KC_SPC), KC_LCTL,    MT(MOD_RCTL,KC_ENT), MT(MOD_RSFT,KC_BSPC), LT(1, KC_DEL), KC_NO  , KC_NO , KC_NO               , KC_NO
  ),

  [1] = LAYOUT_universal(
    KC_F12 , KC_F1            , KC_F2  , KC_F3     , KC_F4  , KC_F5          ,                      KC_F6  , KC_F7  , KC_F8  , KC_F9  , KC_F10 , KC_F11 ,
    KC_TRNS, KC_NO            , KC_PGUP, KC_UP     , KC_PGDN, KC_PSCR        ,                      KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  ,
    KC_TRNS, KC_KB_VOLUME_DOWN, KC_LEFT, KC_DOWN   , KC_RGHT, KC_KB_VOLUME_UP,                      KC_NO  , KC_BTN1, KC_BTN3, KC_BTN2, KC_LALT, KC_LGUI,
    KC_NO  , KC_NO            , KC_HOME, KC_KB_MUTE, KC_END , KC_NO          , KC_NO  ,    KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  ,
