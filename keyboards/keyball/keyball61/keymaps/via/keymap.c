...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_universal(
    ...
    KC_TRNS, KC_KB_VOLUME_DOWN, KC_LEFT, KC_DOWN   , KC_RGHT, KC_KB_VOLUME_UP,                      KC_NO  , KC_BTN1, KC_BTN3, KC_BTN2, KC_NO , KC_TRNS,
    KC_NO  , KC_NO            , KC_HOME, KC_KB_MUTE, KC_END , KC_NO          , KC_NO  ,    KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO , KC_TRNS,
